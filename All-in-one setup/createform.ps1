...
'@; 
	...
	$tmpVariables = @'
[{"name":"afasFunctionCode","value":"{{form.afasJobTitles.FunctionId}}","secret":false,"typeConstraint":"string"},{"name":"afasLocationId","value":"{{form.afasOrgUnits.Id}}","secret":false,"typeConstraint":"string"},{"name":"nedapTeamsIds","value":"{{form.nedapTeams.toJsonString}}","secret":false,"typeConstraint":"string"}]
'@ 

	$delegatedFormTaskGuid = [PSCustomObject]@{} 
$delegatedFormTaskName = @'
Nedap-ons-add-teams-rule
'@
